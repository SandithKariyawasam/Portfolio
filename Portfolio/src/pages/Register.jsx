            ...
            >
              ...
              <div className="text-center mb-40">
                ...
                <h1 className="section-heading" style={{ fontSize: '32px', marginBottom: '10px', justifyContent: 'center' }}>
                  <img src={star2} alt="Star" /> Admin Register <img src={star2} alt="Star" />
                </h1>
                <p style={{ color: 'var(--text-color)', fontSize: '15px' }}>
                  Create a new admin account to manage your portfolio.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <label htmlFor="confirmPassword" style={{ color: 'var(--icon-color)', fontSize: '14px', fontWeight: 'bold', marginLeft: '5px' }}>Confirm Password</label>
                  <input
                    type="password"
                    id="confirmPassword"
                ...
                <p style={{ marginTop: '20px', color: 'rgba(255, 255, 255, 0.4)', fontSize: '13px', textAlign: 'center', lineHeight: '1.6' }}>
                  Already have an account? <Link to="/login" style={{ color: 'var(--primary_color)', fontWeight: 'bold' }}>Login here</Link> <br />
